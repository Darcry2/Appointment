<?php require_once 'member_register_query.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="member_css/member_register.css">
...
<body>
  <div class="container mt-5">
    <div class="row justify-content-center mt-4">
      <div class="col-md-6">
        <h2 class="text-center mb-5">Member SignUp<hr></h2>
        <form action="member_register.php" method="POST">
          <div class="form-group input-label">
           <label for="lastname mt-3"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-fill-add" viewBox="0 0 16 16">
            ...
            <input type="text" class="form-control input-field mb-4" id="firstname" name="firstname" placeholder="First name" required>
          </div>
          <div class="form-group input-label">
            <label for="lastname mt-3"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-fill-add" viewBox="0 0 16 16">
              <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0Zm-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
            ...
            <input type="text" class="form-control input-field mb-4" id="lastname" name="lastname" placeholder="Last name" required>
          </div>
          <div class="form-group input-label">
          ...
          <div class="form-group input-label">
            ...
            <input type="password" class="form-control input-field mt-1 mb-3" id="password" name="password" placeholder="Password" required>
          </div>
          <div class="form-group text-center">
            <button type="submit" class="form-control button mb-2">SignUp</button>
          </div>
        </form>
      </div>
    </div>

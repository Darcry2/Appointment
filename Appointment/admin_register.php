...
<head>
  ...
  <link rel="stylesheet" href="admin_css/admin.register.css">
...
<div class="container mt-5">
    <div class="row justify-content-center mt-4">
      <div class="col-md-6">
      <h2 class="text-center mb-5">Admin SignUp<hr></h2>
    ...
    <div class="form-group input-label">
        ...
        <input type="text" class="form-control input-field mb-4" id="username" name="username" required>
      </div>
      <div class="form-group input-label">
        ...
        <input type="password" class="form-control input-field mb-4" id="password" name="password" required>
      </div>
      <div class="form-group input-label">
        ...
        <input type="password" class="form-control input-field mt-1 mb-3" id="confirm_password" name="confirm_password" required>
      </div>
      <button type="submit" class="form-control button mb-2">Register</button>
    </form>
  </div>
